...
namespace SignalRApiForSql.Models
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "Create Procedure SignalRPivot As Select tarih,[2],[3],[4],[5] from (select[City],CityVisitCount,Cast([VisitDate] as Date) as tarih from Visitors)as visitTable Pivot (Sum(CityVisitCount) For City in([1],[2],[3],[4],[5])) as pivottable order by tarih asc";
